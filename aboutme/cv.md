...
### Contractor Software Architect and Engineer (2025 - Present)

#### Contract: Apex Fintech Solutions (via Instil)

Apex Fintech Solutions, a financial technology company based in Belfast, have an urgent need for experienced software engineers to deliver a time-sensitive project to avoid a significant financial penalty. Despite having no professional experience in much of their technology stack I got stuck in, hit the ground running, and am well on the way to delivering the project on time.

### Technical Reviewer, The Feedback-driven Developer: Manning (May 2025)

Manning contacted me to review this title. The review consisted of the first four chapters (of nine chapters in total) which described a personal workflow for developing software, guided by the creation of an example application. Overall a lot of great advice.

### Software Architect: Axial3D, Belfast (2022 - 2025)

A deliberate shift from team leadership to technical leadership, facilitated by some strategic delegation of undifferentiated heavy lifting, allowing me to focus on enabling our team of excellent engineers, and me, to deliver quality software into production. I designed systems, interfaces between systems, write code, write automated tests, engage with customers to propose technical solutions, and I was the lead implementer in the continued success of our ISO27001:2013 and ISO27001:2022 accreditation.

### Technical Reviewer, Secrets of the JavaScript Ninja 3rd Edition: Manning (Apr 2025)

Manning contacted me to review this new revision of an already successful title, and of course I said yes.
...
An opportunity arose through my involvement with CodeRanch.com where Bert Bates asked the staff if they wanted to be technical reviewers of his new book. Of course, I did.
...
Part of a small agile team supporting and developing a Java and JSP based financial risk management tool. While on this project I benefited from some training on Unit Testing, and I was hooked, which led me to explore Test Driven Development, which led to a step change improvement to how I built software, which led to a long-lasting joy in the practice of refactoring and working with legacy code.
...
My first Software Engineering job after completing my Master's degree. The first thing they taught me was how to use Adatest 95, and while the tool is no longer in vogue, the principles and values of automated testing were set in me right from the start. There were a couple of Java projects in need of a fresh face, so after a crash course in java I was on my first ever real life project, and the only thing I remember about it was that our source control was a remote file system and rsync. Thankfully, I never encountered that scm pattern again.
